...
NUM_CLASSES = 28
CHANNELS = 3
IMAGE_RESIZE = 227  # AlexNet typically uses 227x227 images
...
model = Sequential()
model.add(Conv2D(filters=96, kernel_size=(11,11), strides=(4,4), activation='relu', input_shape=(IMAGE_RESIZE, IMAGE_RESIZE, CHANNELS)))
